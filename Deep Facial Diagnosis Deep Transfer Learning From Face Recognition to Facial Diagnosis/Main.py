...
root.title("Deep Facial Diagnosis: Deep Transfer Learning From Face Recognition to Facial Diagnosis")
...
font = ('times', 18, 'bold')
title = Label(root, text='Deep Facial Diagnosis: Deep Transfer Learning From Face Recognition to Facial Diagnosis')
